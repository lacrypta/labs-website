...
const hackathons = [
  { month: 'MAR', emoji: '⚡', name: 'FOUNDATIONS', subtitle: 'Lightning Payments Basics', level: 1 },
  { month: 'ABR', emoji: '🔐', name: 'IDENTITY', subtitle: 'Nostr Identity & Social', level: 1 },
  { month: 'MAY', emoji: '💜', name: 'ZAPS', subtitle: 'Lightning + Nostr Integration', level: 2 },
  { month: 'JUN', emoji: '🛒', name: 'COMMERCE', subtitle: 'Lightning Stores & Checkout', level: 2 },
  { month: 'JUL', emoji: '📸', name: 'MEDIA', subtitle: 'Decentralized Storage', level: 3 },
  { month: 'AGO', emoji: '🤖', name: 'AI AGENTS', subtitle: 'Bots & Automation', level: 3 },
  { month: 'SEP', emoji: '🏗️', name: 'INFRASTRUCTURE', subtitle: 'Nodes, Routing, Liquidity', level: 4 },
  { month: 'OCT', emoji: '🌐', name: 'INTEGRATION', subtitle: 'Full-Stack Production Apps', level: 4 },
]
        ...
        <div className="flex flex-col gap-12 max-w-[860px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="text-4xl lg:text-6xl font-bold">
                Lightning Hackathons<br />2026
              </h2>
              <p className="text-muted-foreground text-lg max-w-[480px]">
                8 meses. 8 desafíos. Jurado 100% AI. 16M sats en premios pagados en Bitcoin vía Lightning Network.
              </p>
            </div>

            <div className="flex flex-col items-start lg:items-end gap-1">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-bold font-mono text-[#ff8c00]">16M</span>
                <span className="text-muted-foreground font-mono">sats</span>
              </div>
              <span className="text-sm text-muted-foreground">~$9,600 USD en premios</span>
              <span className="text-xs text-muted-foreground font-mono">Gratis · Open Source · Global</span>
            </div>
          </div>
              ...
              >
                ...
                <div className="flex flex-col gap-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-bold text-xs tracking-wide truncate">{h.name}</span>
                  </div>
                  <p className="text-sm text-muted-foreground truncate">{h.subtitle}</p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 px-6 py-5 rounded-2xl border border-[#ff8c00]/30 bg-[#ff8c00]/5">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Gratuito · Presencial BA + Remoto · Tu código es tuyo</p>
            </div>
            <a

    ...
    <Faq>
      <Container>
        ...
        <List>
          ...
          <Item title="Qué eventos y actividades organizan?" description="">
            ...
            <ul>
              ...
              <li>
                ...
                <strong>evento presencial</strong>, donde finalmente compartimos
                en persona.
              </li>
            </ul>
            <Text>
          ...
          >
            <Text>
              Podes hacerlo enviando satoshis a pozo@lacrypta.ar a traves de tu
              billetera de Bitcoin Lightning.
            </Text>
          </Item>
          <Item

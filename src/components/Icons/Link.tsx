...
export default function Component(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M7.05 11.293L4.93 13.414a4 4 0 005.657 5.657l2.828-2.828a4 4 0 000-5.657l-1.06 1.06a2.5 2.5 0 010 3.536L9.524 18.01a2.5 2.5 0 01-3.535-3.535l2.12-2.121-1.06-1.061z"></path>
